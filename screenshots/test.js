...
(async () => {
  ...
  await page.goto('https://8080-accbeccecbfdbedacabfcdaaacbfdfebffaabfa.examlyiopb.examly.io');
  ...
  await page1.goto('https://8081-accbeccecbfdbedacabfcdaaacbfdfebffaabfa.examlyiopb.examly.io');
